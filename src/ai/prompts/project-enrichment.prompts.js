...
function createProjectEnrichmentPrompts(deps) {
  ...
  function buildProjectContextBuildSystemPrompt() {
    return [
      ...
      'Твоя задача: собрать для другой LLM широкий связный контекст проекта и параллельно вернуть оценки сущностей и связей.',
      ...
      'Сначала собери compiled_context: развернутый, но компактный проектный бриф для другой LLM.',
