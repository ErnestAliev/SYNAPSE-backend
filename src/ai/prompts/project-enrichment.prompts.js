...
const PROJECT_CONTEXT_ENTITY_TYPE_SEMANTICS = Object.freeze([
  ...
  'shape: вспомогательный элемент канвы, маркер, смысловой блок или структурный элемент. Его нельзя автоматически трактовать как полноценную бизнес-сущность без явных связей и описания.',
]);
