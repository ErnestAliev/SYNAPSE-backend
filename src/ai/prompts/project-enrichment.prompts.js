...
function createProjectEnrichmentPrompts(deps) {
  ...
  function buildProjectContextBuildSystemPrompt() {
    ...
    return [
      ...
      'В compiled_context не выводи сырые JSON-ключи, enum-значения и служебные графовые термины.',
      'Запрещено писать literal-form вроде relationMode=..., direction=..., raw_connections, effective graph, sourceType, targetType, sourceKind, targetKind, а также raw type labels вроде person/company/goal/task в скобках или рядом с названием сущности.',
      'Всегда переводи технические поля в естественный русский язык: person -> человек, goal -> цель, undirected или relationMode=equivalent -> связь без явного направления, directed -> связь с направлением от одной сущности к другой.',
      'Финальный текст должен читаться как человеческий проектный бриф, а не как разбор JSON-графа или внутренней схемы.',
