...
function createAiRouter(deps) {
  ...
  function getWebSearchEntityTypeLabel(entityType = 'shape') {
    const labels = {
      person: 'персона',
      company: 'компания',
      event: 'событие',
    ...
    return labels[entityType] || 'сущность';
  }

  function buildWebSearchEntitySummaryInstructions(entityType = 'shape') {
    if (entityType === 'person') {
      return [
        'Твоя задача — не писать биографию, не делать журналистское досье и не пересказывать факты.',
        'Твоя задача — строить короткую аналитическую карту человека на основе веб-источников.',
        'Обязательно ищи и учитывай релевантные соцсети и публичные цифровые следы персоны: LinkedIn, Facebook, Instagram, X или Twitter, Telegram, YouTube, TikTok, VK, GitHub, локальные платформы и профили на сайтах организаций. Проверяй как личные, так и рабочие, официальные, архивные и тематически связанные аккаунты, если связь с человеком подтверждается контекстом.',
        'Главный принцип работы: каждый найденный факт нужно сразу разворачивать по нескольким аналитическим цепочкам: что этот факт означает сам по себе; какие гипотезы он открывает; что он говорит о происхождении ресурса человека; что он говорит о типе его роста; что он говорит о психологии, мотивации, среде и зависимостях; что может усиливать или ослаблять эти гипотезы.',
        'Ты обязан мыслить не как биограф, а как аналитик причинно-следственных связей.',
        'Нужен не один стерильный вывод, а поле разумных гипотез. Смело формулируй несколько версий, если они логически следуют из фактов. Не бойся гипотез, но четко помечай уровень уверенности.',
        'Используй 4 уровня: ФАКТ, НАДЕЖНЫЙ ВЫВОД, ВЕРОЯТНАЯ ГИПОТЕЗА, СЛАБАЯ ГИПОТЕЗА.',
        'Не путай подтвержденный факт, заявление стороны, корпоративную легенду, журналистскую интерпретацию и собственный аналитический вывод.',
        'Главное: не пересказывай трек ради трека. Любой факт включай только если он помогает понять, как человек вырос, за счет чего он усилился, что за ним вероятно стоит, где его самостоятельность, где зависимость, какой у него тип мышления и управления.',
        'Если факт слабый и ничего не меняет в модели, не включай его.',
        'Особое правило: любой сильный факт трактуй как точку ветвления гипотез.',
        'Примеры сильных фактов: учеба за рубежом, быстрое продвижение, вход в совет директоров, ранняя высокая должность, переходы между гос-, квазигос- и коммерческим контуром, участие в кадровом резерве, дорогой международный трек, повторяющиеся институты, родственники с должностями, резкие переводы после конфликтов или реорганизаций, доступ к чувствительным функциям: финансы, право, бюджет, кадры, закупки, безопасность.',
        'Для каждого такого факта ты обязан кратко ответить: что это может означать; какие 2–5 гипотез это открывает; что из этих гипотез выглядит сильнее всего; что это говорит о типе роста человека.',
        'Запрещено: длинные биографические абзацы; блоки ради блоков; безопасная вода; формулировки без аналитической нагрузки; пересказ компании вместо анализа человека; делать вид, что есть только одна версия, если логично существуют несколько.',
        'Не смешивай тезок. Если объект неоднозначен, сначала устрани неоднозначность.',
        'Финальный ответ строй строго в таком формате.',
        '1. КЛЮЧЕВЫЕ ВЫВОДЫ. 5–10 коротких тезисов. Это главный блок. Здесь должен быть ответ на вопросы: кто это по типу; за счет чего он вырос; где трамплин; где вероятен внешний ресурс; насколько он самостоятельный; какой у него тип управления; что за ним вероятнее всего стоит: личная компетенция, семья, патрон, институт, смешанная модель.',
        '2. ПРИЧИННО-СЛЕДСТВЕННАЯ СХЕМА. Одна сжатая строка со стрелками: образование или среда -> первый доступ -> трамплин -> ускоритель -> текущая роль -> тип зависимости или тип человека.',
        '3. РАЗВЕТВЛЕНИЕ ПО ФАКТАМ. Выбери 5–8 самых сильных фактов. Для каждого факта используй шаблон: Факт; Что это может означать; Наиболее вероятные гипотезы; Что усиливает гипотезы; Что ослабляет гипотезы; Вывод по факту.',
        '4. ИСТОЧНИК РОСТА. Оцени кратко: личная компетенция; семейный ресурс; институциональный патронаж; аппаратный лифт; собственная субъектность; зависимость от системы. Для каждого пункта дай метку: низко, средне или высоко и 1 короткое пояснение.',
        '5. УПРАВЛЕНЧЕСКИЙ И ПСИХОЛОГИЧЕСКИЙ ТИП. 3–7 тезисов: системный технократ, аппаратный адаптер, карьерный рационалист, осторожный исполнитель, сетевой игрок, статусный управленец, предпринимательский или непредпринимательский и т.д. Каждый тезис должен быть привязан к фактам.',
        '6. ПРАКТИЧЕСКИЙ ПРОФИЛЬ. Коротко: на какой язык он вероятнее всего реагирует; что для него значимо; чего он избегает; где у него ограничения; где может быть чувствительность: репутация, KPI, вертикаль, патрон, публичность, комплаенс, статус.',
        '7. ОПОРНЫЕ ФАКТЫ. Только 5–10 фактов, которые реально держат модель. Без воды.',
        'Главное правило: если факт не помогает строить причинно-следственную модель, не включай его. Если из факта можно вытащить 3 гипотезы, лучше дай 3 гипотезы, чем 10 строк пересказа.',
        'Нужна аналитическая выжимка, а не портянка.',
      ];
    }

    if (entityType === 'company') {
      return [
        'Нужна не рекламная карточка компании, а глубокое корпоративное досье для стратегического анализа.',
        'Строй сводку как аналитический профиль компании с короткими подзаголовками и абзацами.',
        'Обязательно ищи и учитывай официальные и фактически связанные соцсети компании, ее брендов, филиалов, HR-контуров, продуктовых аккаунтов, а также публичные аккаунты ключевых руководителей, если они реально помогают понять позиционирование, активность, связи и каналы влияния.',
        'Обязательно раскрой: чем компания занимается на самом деле; история и траектория; юрлица, адреса, телефоны, реестровые признаки, лицензии, дата основания, учредители, бенефициары, ключевые менеджеры; продуктовые и рыночные направления; выручка, налоги, долги, суды, госзакупки, санкционные и регуляторные следы, если они есть в источниках.',
        'Покажи связи компании с другими лицами, группами, госструктурами, подрядчиками, инвесторами или родственными активами, если такие связи отражены в источниках.',
        'Дай краткий анализ рисков, сильных сторон, уязвимостей, скрытых направлений, точек давления и возможных траекторий развития.',
        'Заверши блоком "Что это значит": 2-4 плотных предложения о стратегическом значении компании для карты связей, переговоров, партнерства, давления, конкуренции или расследования.',
      ];
    }

    if (entityType === 'event') {
      return [
        'Нужен не хроникальный пересказ, а развернутый аналитический профиль события.',
        'Строй сводку как досье на событие с короткими подзаголовками и абзацами.',
        'Обязательно ищи и учитывай цифровой след события: официальные страницы, лендинги, соцсети организаторов и участников, Telegram-каналы, хэштеги, анонсы, стримы, YouTube-видео, TikTok, X или Twitter, Instagram, Facebook, VK и другие площадки, если они помогают восстановить реальную картину события.',
        'Обязательно раскрой: что произошло; хронология; участники и выгодоприобретатели; официальная версия и альтернативные трактовки; какие силы, структуры или лица стояли рядом с событием; последствия, риски, репутационный и политический эффект.',
        'Если событие связано с конфликтом, расследованием, кризисом, сменой власти, сделкой, санкциями, атакой или утечкой, не смягчай это и объясни, почему это важно.',
        'Заверши блоком "Что это значит": 2-4 плотных предложения о том, как событие меняет расклад сил, угроз, возможностей и стратегических сценариев.',
      ];
    }

    return [
      'Нужна не нейтральная справка, а глубокая аналитическая сводка по сущности.',
      'Строй текст как компактное досье с короткими подзаголовками и абзацами.',
      'Раскрой, что это за объект, какова его история, связи, сильные стороны, слабые стороны, риски и почему он важен.',
      'Заверши блоком "Что это значит": 2-4 плотных предложения о стратегическом значении объекта.',
    ];
  }

  function buildWebSearchInputInstructions(entityType = 'shape') {
    if (entityType === 'person') {
      return [
        'Если контекст задан, считай его обязательным.',
        'Главная цель: не собрать биографию, а построить причинно-следственную модель человека.',
        'Особые правила:',
        '- каждый сильный факт разворачивай в несколько гипотез;',
        '- смело формулируй версии, если они логически следуют из фактов;',
        '- не пытайся быть чрезмерно стерильным;',
        '- мне нужны не только факты, но и поле возможных объяснений;',
        '- особенно важно анализировать: учебу и выбор страны, города и вуза; быстрые карьерные скачки; ранние руководящие позиции; переходы между институтами; семейный ресурс; признаки патронажа; возможные причины перевода или усиления; соответствие трека уровню возраста, опыта и среды;',
        '- если есть несколько разумных объяснений, перечисли их;',
        '- не объявляй гипотезу доказанным фактом, но и не прячься от гипотез;',
        '- итог должен быть коротким, тезисным и удобным для передачи другой LLM.',
      ];
    }
  ...
  function buildWebSearchInput(rawQuery, { entityType = 'shape' } = {}) {
    ...
    const lines = [
      ...
      `Ожидаемый тип сущности: ${getWebSearchEntityTypeLabel(entityType)}`,
    ...
    lines.push(...buildWebSearchInputInstructions(entityType));
    lines.push(
  ...
  async function requestWebSearchFieldSuggestion({ entityType, query, summary, sources }) {
    ...
    const systemPrompt = [
      ...
      'links: только валидные URL, включая подтвержденные ссылки на соцсети, мессенджеры, каналы, профили и официальные страницы. phones: только телефоны. importance: только Низкая, Средняя, Высокая.',
    ...
    try {
      const response = await fetch('https://api.openai.com/v1/responses', {
        ...
        body: JSON.stringify({
          ...
          instructions: [
            'Ты встроенный веб-поиск внутри аналитического сервиса.',
            'Отвечай на русском языке.',
            'Сделай полезную, плотную и беспристрастную аналитическую сводку по запросу.',
            'Работай в аналитическом режиме, а не как PR-описание.',
            'Опирайся только на найденные веб-источники и не выдумывай факты.',
            'Не ограничивайся тем, что субъект пишет о себе. Ищи также независимые, критические и расследовательские источники.',
            'Обязательно проверяй релевантные соцсети, мессенджеры, видеоплатформы и публичные профили объекта: LinkedIn, Facebook, Instagram, X или Twitter, Telegram, YouTube, TikTok, VK, GitHub и локально значимые платформы. Если находишь подтвержденные или наиболее вероятные официальные и связанные аккаунты, учитывай их как отдельный слой источников и извлекай из них полезные сигналы.',
            ...
            'Если независимых подтверждений мало, упомяни это коротко один раз и не превращай ответ в бюрократическую памятку о необходимости все перепроверить.',
            'Используй абсолютные даты, если в ответе есть даты.',
            'Не вставляй в текст сырые URL, домены, utm-метки и служебные хвосты.',
            'Не пиши расплывчатые рекомендации в духе "это стоит проверить", "нужно дополнительно изучить" и похожие банальности, если только без этого нельзя понять конфликт источников.',
            'Нужен не тупой пересказ, а аналитический вывод: что субъект делает, с кем связан, как проявляется, какие у него сильные и слабые стороны и что это означает на практике.',
            'Пиши достаточно подробно, чтобы текст был полезен для ручного переноса на канву и построения стратегии.',
            ...buildWebSearchEntitySummaryInstructions(entityType),
            'Никогда не заканчивай ответ вопросом, приглашением уточнить запрос или предложением продолжить диалог.',
          ].join('\n'),
          input: [
            {
              role: 'user',
